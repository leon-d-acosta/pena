...
class _ChangeApelidoState extends State<ChangeApelido> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Trocar meu apelido", style: TextStyle(color: c.branco)),
              ...
              child: Column(
                ...
                children: [
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("Meu apelido atual:", style: TextStyle(color: c.preto, fontSize: 18, fontWeight: FontWeight.bold)),
                      Text(widget.apelido, style: const TextStyle(color: c.azul_1, fontSize: 30, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  TextField(
